...
const sttaddr = "0x1D5A6bFeDC993Ef3885067262B401270DeBE2e72";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x1D5A6bFeDC993Ef3885067262B401270DeBE2e72";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://galaxytoken.finance?ref=' + document.getElementById('refaddress').value;
        }
    }
}
